...
<div class="container" style="margin-top: 3rem;">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <form action="/diandiancar/customer/rent/pay" method="post" id="myform">
                ...
                <div class="form-group row">
                    <label for="input3" class="col-sm-2 col-form-label">租金：</label>
                    <div class="col-sm-10">
                        <input type="text" name="paymentAmount" readonly class="form-control" id="input3" value="${rentDTO.paymentAmount}(元/天)">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input4" class="col-sm-2 col-form-label">租借起始日：</label>
                    <div class="col-sm-10">
                        <input name="beginDate" type="date" id="input4" value="<fmt:formatDate value="${rentDTO.beginDate  }" pattern="yyyy-MM-dd"/>" class="form-control" placeholder="租借起始日"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input5" class="col-sm-2 col-form-label">租借结束日：</label>
                    <div class="col-sm-10">
                        <input name="endDate" type="date" id="input5" value="<fmt:formatDate value="${rentDTO.endDate  }" pattern="yyyy-MM-dd"/>" class="form-control" placeholder="租借结束日"/>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-left: 40%;">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="submit" id="submit" class="btn btn-success" value="确认支付" disabled>
                </div>
            </form>
        </div>
